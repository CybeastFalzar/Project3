...
BEGIN
	...
	FOREIGN KEY(Class) REFERENCES Courses.Class(Class)

	ALTER TABLE Courses.CourseClass
	ADD CONSTRAINT FK_CourseClass_ModeOfInstruction
	FOREIGN KEY(ModeOfInstruction) REFERENCES Courses.ModeOfInstruction(InstructionType)

	ALTER TABLE Location.BuildingRooms
	ADD CONSTRAINT FK_BuildingRooms_BuildingLocation
	FOREIGN KEY(BuildingName) REFERENCES Location.BuildingLocation(BuildingName)

	ALTER TABLE Location.BuildingRooms
	ADD CONSTRAINT FK_BuildingRooms_RoomLocation
	FOREIGN KEY(RoomNo) REFERENCES Location.RoomLocation(RoomNo)

	ALTER TABLE Courses.Course
	ADD CONSTRAINT FK_Course_Department
	FOREIGN KEY(Department) REFERENCES Staff.Department(DepartmentName)

	ALTER TABLE Staff.InstructorDepartments
	ADD CONSTRAINT FK_InstructorDepartments_Department
	FOREIGN KEY(DepartmentName) REFERENCES Staff.Department(DepartmentName)

	ALTER TABLE Staff.InstructorDepartments
	ADD CONSTRAINT FK_InstructorDepartments_Instructor
	FOREIGN KEY(InstructorID) REFERENCES Staff.Instructor(InstructorID)
